...
async function scrapeWebsite(request) {
    ...
    try {
        ...
        while (currentStep < request.maxSteps) {
            ...
            const analysisResult = await (0, llm_1.analyzeContentAndDecideNextAction)(pageStructure, // Send structured data instead of raw HTML
            ...
            console.log(`LLM suggested clicking element ID: ${analysisResult.nextActionElementId}`);
            ...
            if (analysisResult.nextActionElementId.startsWith("link-")) {
                ...
                if (link?.href) {
                    ...
                    try {
                        ...
                        console.error(`Failed to click link selector: ${elementSelector}`, clickError);
                        return {
                            isError: true,
                    ...
                    console.warn(`Could not find href for ${analysisResult.nextActionElementId}`);
                    return {
                        isError: true,
                ...
                try {
                    ...
                    console.error(`Failed to navigate to: ${analysisResult.nextActionElementId}`, navError);
                    return {
                        isError: true,
                ...
                console.warn(`LLM suggested clicking unknown element type: ${analysisResult.nextActionElementId}`);
                return {
                    isError: true,
