...
const openai = new openai_1.default((0, config_1.getOpenAIConfig)());
async function analyzeContentAndDecideNextAction(pageStructure, targetSchema, query, pageHistory = []) {
